...
def gendata_process(seed):
    while True:
        ...
        try:
            gen = generate_data(i, generate_data_config.num_total, generate_data_config.num_each_min, generate_data_config.num_each_max, generate_data_config.rate_clauses_min, generate_data_config.rate_clauses_max, generate_data_config.rate_three, verbose=True)
...
def main():
    ...
    for i in range(generate_data_config.GEN_COUNT):
        q.put(i)
